...
<<<<<<< HEAD
                                                                    <td style="word-break: break-word; overflow-wrap: anywhere;">
                                                                        ${po.bankName} (
                                                                        <c:choose>
                                                                            <c:when test="${not empty po.accountNumber && fn:length(po.accountNumber) > 4}">
                                                                                ${fn:substring(po.accountNumber, 0, fn:length(po.accountNumber) - 4)}****
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                ${not empty po.accountNumber ? '****' : '-'}
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                        )
                                                                    </td>
...
<<<<<<< HEAD
                                                                    <td style="word-break: break-word; overflow-wrap: anywhere;">
                                                                        <c:choose>
                                                                            ...
                                                                            <c:when test="${po.status == 'rejected' && not empty po.adminNote}">
                                                                                <small class="text-danger d-block" style="word-break: break-word; overflow-wrap: anywhere; line-height: 1.35;">
                                                                                    <strong>Lý do từ chối:</strong> <c:out value="${po.adminNote}"/>
                                                                                </small>
                                                                            </c:when>
                                                                            <c:otherwise>
...
<<<<<<< HEAD
                            ...
                            <textarea name="note" id="withdrawNote" class="form-control" rows="2" 
                                      placeholder="Ghi chú thêm nếu cần (tối đa 50 ký tự)..." 
                                      maxlength="50"
