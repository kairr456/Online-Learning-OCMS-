                    ...
                    <div class="tgmenu__wrap">
                        <nav class="tgmenu__nav">
                            ...
                            <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                <ul class="navigation">
                                    <li><a href="${pageContext.request.contextPath}/view/common/homepage.jsp">Home</a></li>
                                    <li><a href="${pageContext.request.contextPath}/view/common/browse-course.jsp">Courses</a></li>
                            ...
                            <div class="tgmenu__action">
                                <ul class="list-wrap">
                                    ...
                                    <li class="mini-cart-icon">
                                        <a href="${pageContext.request.contextPath}/view/addcart/cart.jsp" class="cart-count">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a href="${pageContext.request.contextPath}/authen?action=login"></a>
                                        </c:otherwise>
                                    </c:choose>
                                    </li>
                                </ul>
