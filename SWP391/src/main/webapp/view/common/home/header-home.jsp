            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="tg-header__top-info list-wrap">
                        <li>
                            <img src="${pageContext.request.contextPath}/assets/img/icons/map_marker.svg" alt="Icon"> 
                            <span>589 5th Ave, NY 10024, USA</span>
                        </li>
                        <li>
                            <img src="${pageContext.request.contextPath}/assets/img/icons/envelope.svg" alt="Icon"> 
                        ...
                        <nav class="tgmenu__nav">
                            ...
                            <div class="tgmenu__search d-none d-md-block">
                                <form action="${pageContext.request.contextPath}/course-list" method="GET" class="tgmenu__search-form">
                                    ...
                                    <div class="input-grp">
                                        <input type="text" name="keyword" placeholder="Search For Course . . .">
                                        <button type="submit"><i class="flaticon-search"></i></button>
                                    </div>
                                </form>
                            </div>

                            <!-- Header Actions (Wishlist, Cart, Login/Logout) -->
                            <div class="tgmenu__action">
                                <ul class="list-wrap">
                                    <li class="wishlist-icon">
                                        <a href="${pageContext.request.contextPath}/wishlist" class="cart-count">
                                            <img src="${pageContext.request.contextPath}/assets/img/icons/heart.svg" class="injectable" alt="Wishlist">
                                            <span class="wishlist-count">${sessionScope.wishlistCount != null ? sessionScope.wishlistCount : 0}</span>
                                        </a>
                                    </li>
                                    <li class="mini-cart-icon">
                                        <a href="${pageContext.request.contextPath}/cart" class="cart-count">
                                            <img src="${pageContext.request.contextPath}/assets/img/icons/cart.svg" class="injectable" alt="Cart">
                                            <span class="mini-cart-count">${sessionScope.cartCount != null ? sessionScope.cartCount : 0}</span>
                                        </a>
                                    </li>
                            ...
                            <!-- Mobile Quick User Button -->
                            <div class="mobile-login-btn">
                                <c:choose>
                                    <c:when test="${sessionScope.account != null}">
                                        <a href="${pageContext.request.contextPath}/dashboard-profile">
                                            <img src="${pageContext.request.contextPath}/assets/img/icons/user.svg" alt="Profile" class="injectable">
                                        </a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="${pageContext.request.contextPath}/authen?action=login">
                                            <img src="${pageContext.request.contextPath}/assets/img/icons/user.svg" alt="Login" class="injectable">
                                        </a>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                    ...
                    <div class="tgmobile__menu">
                        <nav class="tgmobile__menu-box">
                            ...
                            <div class="tgmobile__menu-outer">
                                <!-- Dynamic JS Mobile Menu Container -->
                            </div>
