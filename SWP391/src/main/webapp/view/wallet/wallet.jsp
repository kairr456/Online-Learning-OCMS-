    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body data-has-bank="${not empty bankAccount}"
                ...
                data-flash-message="${sessionScope.message}" data-flash-type="${sessionScope.messageType}">

                <!-- Xóa message khỏi session sau khi đã lấy ra biến data-* -->
                <% session.removeAttribute("message"); session.removeAttribute("messageType"); %>
                            ...
                            <div class="wallet-main-grid">
                                ...
                                <div>
                                    ...
                                    <div class="wallet-panel">
                                        ...
                                        <ul class="list-unstyled text-muted font-14 mb-0"
                                            style="font-size: 13.5px; line-height: 1.8;">
                    ...
                    <script>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            // Hiển thị Toast thông báo từ session thông qua data attribute an toàn
